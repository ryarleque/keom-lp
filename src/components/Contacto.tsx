  ...
  return (
    <Section tone="paper" id="contacto" className="bg-paper-2">
      <div className="mx-auto max-w-xl text-center">
        ...
        <p className="mx-auto mt-5 max-w-md text-[0.98rem] leading-relaxed text-on-paper-soft">
          {CONTACT_COPY.body}
        </p>
        ...
        <a
          ...
          className="press mt-8 inline-flex items-center gap-2.5 rounded-xl bg-[#25D366] px-7 py-3.5 font-display text-[0.9rem] font-bold uppercase tracking-[0.06em] text-white hover:brightness-105"
        >
          <WhatsApp size={18} />
          {CONTACT_COPY.cta}
        </a>

        <p className="mt-4 text-[0.78rem] text-on-paper-mute">{CONTACT_COPY.note}</p>

        <div className="mt-10 flex flex-wrap items-center justify-center gap-x-10 gap-y-4 border-t border-paper-line pt-8">
          <span className="flex items-center gap-2.5 text-[0.86rem] text-on-paper-soft">
          ...
          <a
            ...
            className="flex items-center gap-2.5 text-[0.86rem] text-on-paper-soft transition-colors hover:text-on-paper"
          >
